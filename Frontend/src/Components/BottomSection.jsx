...
const BottomSection = () => {
  return (
    <>
      <div className="font-[roboto] flex flex-col items-center bg-[#1B1919] text-white p-6 pt-2 mb-10 mx-[35px] mt-[60px] rounded-3xl space-y-3 font-roboto">
        <h1 className="mb-1 text-2xl font-bold">Ready to Start Earning?</h1>
